...
describe('live artifact store layout', () => {
  ...
  it('maps document refresh data paths directly even when a legacy transform is present', () => {
    const document: any = {
      ...
      dataJson: {
        repository: {
          fullName: 'Gary-Ge-xixi/open-design',
          url: 'https://github.com/Gary-Ge-xixi/open-design',
          starCount: 100,
      ...
      sourceJson: {
        ...
        input: { url: 'https://api.github.com/repos/Gary-Ge-xixi/open-design' },
        outputMapping: {
          dataPaths: [
    ...
    const candidate = buildLiveArtifactRefreshCandidate({
      ...
      documentOutput: {
        output: {
          ...
          full_name: 'Gary-Ge-xixi/open-design',
          html_url: 'https://github.com/Gary-Ge-xixi/open-design',
